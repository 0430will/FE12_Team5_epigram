...
export default function MyUserProfile() {
  ...
  return (
    <section className="pc:mb-[96px] mb-[56px] flex flex-col items-center">
      {!user && !isLoading && (
        <section className="pc:mb-[96px] mb-[56px] flex flex-col items-center">
          <div className="mb-[16px] h-[120px] w-[120px] rounded-full bg-blue-300">
            <div className="h-full w-full animate-pulse cursor-default rounded-full object-cover"></div>
          </div>
        ...
        <>
          ...
          {editMode ? (
            <input
              ...
              className="mb-[16px] h-[25px] rounded px-4 py-5"
            />
          ) : (
